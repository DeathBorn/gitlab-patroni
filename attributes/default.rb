...
default['gitlab-patroni']['config']['bootstrap']['users']['gitlab-superuser']['password'] = 'in-vault'
default['gitlab-patroni']['config']['bootstrap']['users']['gitlab-superuser']['options'] = %w(createrole createdb)
default['gitlab-patroni']['config']['bootstrap']['users']['gitlab-replicator']['password'] = 'in-vault'
default['gitlab-patroni']['config']['bootstrap']['users']['gitlab-replicator']['options'] = ['replication']
...
default['gitlab-patroni']['config']['postgresql']['authentication']['replication']['username'] = 'gitlab-replicator'
default['gitlab-patroni']['config']['postgresql']['authentication']['replication']['password'] = 'in-vault'
default['gitlab-patroni']['config']['postgresql']['authentication']['superuser']['username'] = 'gitlab-superuser'
default['gitlab-patroni']['config']['postgresql']['authentication']['superuser']['password'] = 'in-vault'
...
default['gitlab-patroni']['config']['postgresql']['parameters']['unix_socket_directories'] = '/tmp'
